...
    : 'border-border';
  ...
  return (
    <Card
      className={`cursor-pointer border bg-card transform transition-transform duration-200 ease-out shadow-md hover:shadow-lg hover:scale-105 hover:border-secondary/50 ${selectionClasses}`}
