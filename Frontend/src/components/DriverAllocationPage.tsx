...
export function DriverAllocationPage({ onLogout, onViewDrivers, onViewStudents, drivers, onAddDriver }: DriverAllocationPageProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Basic validation
    if (!busPlate || !busNumber || !driverName || !driverNumber || !driverGender || !driverContact || !driverEmail) {
          ...
          <div className="flex items-center justify-between mb-8">
            ...
            <div className="flex items-center gap-3">
              ...
              <Button
                onClick={onLogout}
                variant="outline"
                className="flex items-center gap-2 border-2 border-red-500 text-red-500 hover:text-white hover:bg-red-500 transform transition-transform duration-300 hover:scale-110"
              >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <Card className="shadow-lg bg-gray-100 border border-black">
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-2">
                  <Label htmlFor="driverEmail" className="text-foreground">
                    Driver Email *
                  </Label>
                  <div className="relative">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="bg-accent/10 border-l-4 border-amber-500 p-4 rounded-r-lg bg-amber-200">
                    ...
                    <p className="text-sm text-foreground">
                      Email: {driverEmail || "Not specified"}
                    </p>
                  </div>
                </div>
                ...
                <div className="flex justify-center">
                  <Button
                    type="submit"
                    className="px-8 py-3 bg-[#1e3a8a] hover:bg-primary/90 text-primary-foreground transform transition-transform duration-300 hover:scale-110"
                    disabled={loading}
                  >
                    {loading ? (
