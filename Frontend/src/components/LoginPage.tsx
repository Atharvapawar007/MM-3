  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        // Store the userId directly from the response
        if (data.userId) {
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                ...
                <a
                  ...
                  className="text-primary font-semibold text-base underline-offset-2 hover:underline focus:underline transition-colors"
                  tabIndex={0}
                >
                  Forgot password?
                </a>
