...
export function BusCard({ bus, isSelected, onSelect, studentCount }: BusCardProps) {
  const selectionClasses = isSelected
    ? 'ring-2 ring-primary border-primary bg-primary/5 shadow-elevated'
    : 'border-border hover:border-primary/50 hover:shadow-elevated shadow-card';
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">
                Driver #{bus.driverId?.padStart(4, '0')}
              </p>
            </div>
          </div>
